...
extension DependencyValues {
    ...
    private enum UUIDGeneratorKey: DependencyKey {
        static var defaultValue: UUIDGenerator = .random
    }
    ...
    ///
    public struct UUIDGenerator: Sendable, DependencyKey {
        public static var defaultValue: Self =  .random
